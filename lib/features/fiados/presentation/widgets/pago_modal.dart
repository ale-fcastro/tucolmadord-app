    ...
    builder: (ctx) {
      return StatefulBuilder(
        builder: (ctx, setState) {
          ...
          final nuevoPendiente = (customer.balance - amount).clamp(
            0,
            double.infinity,
          );
          ...
          final quickAmounts = <double>{
            ...
            200,
            500,
          }.where((v) => v > 0 && v <= customer.balance).toList()..sort();
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppLabel(
                            'Debe actualmente: ${Money.label(customer.balance)}',
                          ),
