                  ...
                  SizedBox(
                    ...
                    child: ListView(
                      ...
                      children: _categories.map((c) {
                        final selected =
                            state.search.isEmpty && state.category == c;
                        return Padding(
        ...
        switch (product.mode) {
          ...
          case SellMode.amount:
            showAmountModal(
              context,
              product: product,
              onConfirm: (amount) => cubit.addAmountToCart(product, amount),
            );
          case SellMode.weight:
            showWeightModal(
              context,
              product: product,
              onConfirm: (qty) => cubit.addWeightToCart(product, qty),
            );
        }
      },
      child: Stack(
